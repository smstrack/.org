 ...
 * 
 * 
 * @example $('table').tablesorter({ headers: { 0: {sorter:"integer"}, 1:
 *          {sorter:"currency"} } });
 * 
    ...
    $
		...
		tablesorter : new function()
		{
			...
			for ( var i = 0; i < l; i++)
			{
			    ...
			    // var s =
			    // (getCachedSortType(table.config.parsers,c) ==
			    // "text") ?
			...
			if (type == 'text' && direction == 'asc')
			{
			    return "(" + a + " == " + b + " ? 0 : (" + a + " === null ? Number.POSITIVE_INFINITY : ("
				    + b + " === null ? Number.NEGATIVE_INFINITY : (" + a + " < " + b
				    + ") ? -1 : 1 )));";
			} else if (type == 'text' && direction == 'desc')
			{
			    return "(" + a + " == " + b + " ? 0 : (" + a + " === null ? Number.POSITIVE_INFINITY : ("
				    + b + " === null ? Number.NEGATIVE_INFINITY : (" + b + " < " + a
				    + ") ? -1 : 1 )));";
